...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AllGridDao.createTable(db, ifNotExists);
        PointDao.createTable(db, ifNotExists);
        DailyTblDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        AllGridDao.dropTable(db, ifExists);
        PointDao.dropTable(db, ifExists);
        DailyTblDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AllGridDao.class);
        registerDaoClass(PointDao.class);
        registerDaoClass(DailyTblDao.class);
    }
